...
static const char qt_meta_stringdata_Connection[] = {
    "Connection\0\0msg\0messageReceived(Message)\0"
    "sendMessage(Message)\0receiveData()\0"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->messageReceived((*reinterpret_cast< Message(*)>(_a[1]))); break;
        case 1: _t->sendMessage((*reinterpret_cast< Message(*)>(_a[1]))); break;
...
// SIGNAL 0
void Connection::messageReceived(Message _t1)
{
